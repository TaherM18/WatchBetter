<?php
$fetchAdmin = "SELECT email_id, contact, address FROM users WHERE user_type = 'A' LIMIT 1";
$rs = $con->query($fetchAdmin);
if ($rs->num_rows == 1) {
    $row = $rs->fetch_assoc();
    $aEmail = $row["email_id"];
    ...
    $aEmail = "bhalodiyazeenal@gmail.com";
    $aContact = "+91 87994 78161";
    $aAddress = "Varachha, Surat, Gujarat";
}
?>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                    ...
                    <p class="text-white d-flex mb-1">
                        <a href="tel: <?= $aContact ?>" class="site-footer-link">
                            <?= $aContact ?>
                        </a>
                    </p>

                    <p class="text-white d-flex">
                        <a href="mailto: <?= $aEmail ?>" class="site-footer-link">
                            <?= $aEmail ?>
                        </a>
                    </p>
                </div>
